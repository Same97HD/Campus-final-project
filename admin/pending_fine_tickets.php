...
<head>
    <title>Pending Fine Tickets | Traffic Police Admin</title>
...
<body class="overlay-scrollbar">
	...
	<?php
	   ...
	   $sql = "SELECT * FROM issued_fines WHERE status='pending'";
    ...
    <div class="leftsidebar overlay-scrollbar scrollbar-hover">
        <ul class="leftsidebar-nav overlay-scrollbar scrollbar-hover">
            ...
            <li class="leftsidebar-nav-item">
                <a href="pending_fine_tickets.php" class="leftsidebar-nav-link active">
                    <div>
    ...
    <div class="dashwrapper">
            <div class="container-fluid">
                <h1 class="mt-4">Pending Fine Tickets</h1>
