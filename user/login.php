...
<head>
    ...
    <!--Meta tags start-->
    <meta charset="UTF-8">
    <meta name="description" content="Traffic Offence Management System for Sri Lanka">
            ...
            <div class="col-sm-9 col-md-7 col-lg-5 mx-auto">
                <div class="card card-signin my-5">
                    <div class="card-body animated fadeIn">
                        <h1 class="card-icon"><i class="fas fa-user"></i></h1>
				...
				<?php } ?>
                        ...
                        <form class="form-signin" action="login_action.php" method="POST">
                            <div class="form-label-group">
                                <input type="text" id="inputDL" class="form-control" placeholder="Driving License No" name="license_id">
                            </div>
                            <div class="form-label-group">
                                <input type="password" id="inputPassword" class="form-control" placeholder="Password" name="driver_password">
                            </div>
                            <button class="btn btn-lg btn-block text-uppercase" type="submit">Log in</button>
                            <hr class="my-4">
                            <h6 style="text-align: center; text-decoration: none;"><span><a href="forgot-password.php"><i class="fas fa-unlock-alt"></i> Forget Password?</a></span> <span class="ml-2 homelink"><a href="../index.php"><i class="fas fa-home"></i> Home</a></span></h6>
                        </form>
                    </div>
                </div>
            </div>
