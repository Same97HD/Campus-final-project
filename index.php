...
<head>
    ...
    <!--Meta tags start-->
    <meta charset="UTF-8">
    <meta name="description" content="Traffic Offense Management System ">
    ...
    <div class="topnavbar animated fadeIn">
        ...
        <ul class="topnavbar-nav">
            <li class="topnav-item">
                <a href="index.php"><img src="assets/img/Hero.png" alt="TOMS logo" class="logo logo-light"></a>            
            </li>
        </ul>
        <!-- end topnav left -->
        <!-- topnav right -->
                        ...
                        <div class="container">
                            <div class="row mt-4">
                                ...
                                <div class="col-md-6 animated bounceInDown custom-slide-animi">
                                    <div class="img-box">
                                        <img src="assets/img/Hero_6.png" alt="">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="carousel-item ">
                        <div class="container">
                            <div class="row mt-4">
                                ...
                                <div class="col-md-6 animated bounceInUp custom-slide-animi">
                                    <div class="img-box">
                                        <img src="assets/img/Hero_5.png" alt="">
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="container animated fadeIn">
                <div class="row">
                    <div class="footer-col">
                        ...
                        <ul>
                            <li><a href="tel:+94714590249"><i class="fas fa-phone"></i> +94 764851952</a></li>
                        </ul>
                    </div>
                    <div class="footer-col">
                        <h4>Inquiry via email</h4>
                        <ul>
                            <li><a style="text-transform: lowercase;" href="mailto:sameerachamara10@gmail.com" target="_blank"> <i class="fas fa-envelope"></i>sameerachamara10@gmail.com</a></li>
                        </ul>
                    </div>
                    <div class="footer-col">
                        <h4>Other Links</h4>
